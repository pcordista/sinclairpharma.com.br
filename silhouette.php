...
<div class="ellanse-pages">
    <?php include 'silhouette-menu.php'; ?>
    <div class="page-representantes-banner">
        <img src="assets/img/silhouette-banner.png" class="widthfull">
    </div>
    ...
    <div class="sectionStart representantes-intro faq">
        <div class="containerEighteen">
            <div class="intro">
                ...
                <p>É normal que algumas dúvidas surjam durante a realização do procedimento com Ellansé. E estamos aqui para esclarecê-las!</p>
                <BR>
                <h2>Confira as mais comuns:</h2>
            </div>
    ...
    <?php include 'ellanse-footer.php'; ?>
</div>
